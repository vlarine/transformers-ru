...
from transformers_dev.modeling_bert import (BertConfig, BertEncoder,
                                                BertIntermediate, BertLayer,
                                                BertModel, BertOutput,
                                                BertSelfAttention,
                                                BertSelfOutput)
from transformers_dev.modeling_roberta import (RobertaEmbeddings,
                                                   RobertaForMaskedLM,
...
def convert_roberta_checkpoint_to_pytorch(roberta_checkpoint_path, pytorch_dump_folder_path, classification_head, vocab_size=50265):
    """
    Copy/paste/tweak roberta's weights to our BERT structure.
    """
    roberta = FairseqRobertaModel.from_pretrained(pytorch_dump_folder_path, roberta_checkpoint_path)
